...
set.seed(261081)
boxplot(cbind(x <- rnorm_cont(16,25,8,cshift=0,csd=24),y <- rnorm_cont(16,19,8,cshift=0,csd=24)),ylim=c(0,56))
cond_power_rule_norm_ts(x[1:8],y[1:8],delta=8,target=.8,rob_var=F)
xE <- rnorm_cont(6,25,8,cshift=0,csd=24)
yE <- rnorm_cont(6,19,8,cshift=0,csd=24)

adaperm(c(x,xE,y,yE),g=rep(0:1,each=22),8,16,test_statistic=ranksum,cer_type='randomized',atest_type='non-randomized')
adaptive_invnormtest_2s(c(y,yE),c(x,xE),8,16,22)
