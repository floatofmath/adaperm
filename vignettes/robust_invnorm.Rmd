...
permutation_CER2 <- function(x1,g1,x2,stat=sumdiff,
  ...
  trimmings <- (alpha - mean(dist>=talpha))
...
trimmings <- sapply(1:ncol(x1s),function(i) permutation_CER2(x1s[,i],sign(x1s[,i]),x2s[,i],stat=signedranks,one_sample=T,permutations=10000))
all(trimmings>0)
summary(trimmings)
