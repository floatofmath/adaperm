...
Gs <- expand.grid(ne=seq(10,100,10),n1=5,n=10,permutations=10000)
## medium preplanned trial
Gm <- expand.grid(ne=seq(30,100,10),n1=15,n=30,permutations=10000)
## large preplanned trial
Gl <- expand.grid(ne=seq(60,100,5),n1=30,n=60,permutations=10000)

G <- rbind(Gs,Gm,Gl)
power_second_stage <- run_simulation_general(G,B=1000)
