...
#     browser()
    ...
    results %>% bind_rows %>% summarize(ASN=mean(ne),maxSN=max(ne),
                                        ...
                                        perm_CERother_Aother =mean(perm_CERrndmz_Aother),
                                        perm_ratio_CERnonrndmz_Anonrndmz =  mean(perm_ratio_CERnonrndmz_Anonrndmz),
                                        perm_ratio_CERother_Aother =  mean(perm_ratio_CERrndmz_Aother),
...
```{r}
library(pander)
load(vfile("../data/sim_counts_poisson_n5",ending="rda"))
