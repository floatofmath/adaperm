...
sim_counts_poisson=run_simulation_counts(scenarios_test,B=100,rule=condpowerrule_counts,rdist=r_counts,test_statistic=meandiff,resam=100)
sim_counts_poisson
...
scenarios_test$n=scenarios_test$n1*2
# debug(run_scenario_counts)
sim_countsEQ=run_simulation_counts(scenarios_test,B=10,rule=condpowerrule_counts,rdist=r_counts,test_statistic=meandiff,resam=10)
