...
adaperm_DR(c(x,y),c(rep(0,ne),rep(1,ne)),n1,n,
           test=meandiff,cer_type='non-randomized',atest_type='midp')
...
#     browser()
    ...
    results %>% bind_rows %>% summarize(ASN=mean(ne),maxSN=max(ne),
                                        ...
                                        perm_CERrndmz_Aother =mean(perm_CERrndmz_Aother),
                                        perm_CERnonrndmz_Aother =mean(perm_CERnonrndmz_Aother),
                                        perm_ratio_CERrndmz_Anonrndmz = mean(perm_ratio_CERrndmz_Anonrndmz) ,
                                        perm_ratio_CERnonrndmz_Anonrndmz =  mean(perm_ratio_CERnonrndmz_Anonrndmz),
                                        perm_ratio_CERrndmz_Aother =  mean(perm_ratio_CERrndmz_Aother),
                                        perm_ratio_CERnonrndmz_Aother = mean(perm_ratio_CERnonrndmz_Aother),
...
sim_counts_poisson=run_simulation_counts(scenarios_test,B=10,rule=condpowerrule_counts,rdist=r_counts,test_statistic=meandiff,resam=10)
sim_counts_poisson
