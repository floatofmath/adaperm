...
find_param(function(n0,param,delta) rt(n0,4,ncp=delta*param),30,target=.70)
...
find_param(function(n0,param,delta) rt(n0,4,ncp=delta*param),100,target=.70,low=.1,up=10)
...
out <- list() 
for(i in c(10:18)) out[[i]] <- bind_cols(scenarios[i,],simulate_scenario(scenarios[i,],B=1000))
sims <- bind_rows(out)
