...
scenarios <- data_frame(n1 = rep(c(rep(5,3),rep(50,3),rep(15,3),rep(10,3)),2),
                ...
                lambda = rep(c(rep(460e-4,3),rep(570e-5,3),rep(160e-4,3),rep(180e-4,3)),2),
...
## about 3.5h for 1e4
for(i in 4:6) medium_scenarios[[i]] <- bind_cols(scenarios[medium_index[i],],simulate_scenario(scenarios[medium_index[i],],B=1e4))
...
load('~/srv-home/adaperm_simresults/small_simulations_newrules_node6_161006.Rd')
load('~/srv-home/adaperm_simresults/medium_simulations_newrules_node6_161006.Rd')
