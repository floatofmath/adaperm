...
scenarios <- data_frame(n1 = rep(c(rep(5,3),rep(50,3),rep(15,3),rep(10,3)),2),
                ...
                lambda = rep(c(rep(460e-4,3),rep(570e-5,3),rep(150e-4,3),rep(180e-4,3)),2),
...
load('~/srv-home/adaperm_simresults/large_simulations_newrules_node6_161004.Rd')
...
simtab <- sims[,-c(1,4,8:9,10,12)]
simtab[,8:12] <- simtab[,8:12] * 100
simtab <- simtab[with(simtab,order(dists[distribution],n,delta0)),]
