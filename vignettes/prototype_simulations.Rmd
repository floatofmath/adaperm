...
run_scenario <- function(scenario){
    ...
    ans <- data_frame(
        ...
        adaperm_t=adaperm_DR(c(x,y),rep(0:1,each=nE),n1=n1,n=n,m1=m1,m=m,test=tstat,cer_type='randomized',atest_type='non-randomized',permutations=10^5),
        adaperm_rw=adaperm_DR(c(x,y),rep(0:1,each=nE),n1=n1,n=n,m1=m1,m=m,test=ranksum,cer_type='randomized',atest_type='non-randomized',permutations=10^5),
        adaperm_w=adaperm_DR(c(x,y),rep(0:1,each=nE),n1=n1,n=n,m1=m1,m=m,test=ranksum,cer_type='non-randomized',atest_type='non-randomized',permutations=10^5)
    )
    return(ans)
}
...
scenarios <- data_frame(n1 = rep(c(rep(5,3),rep(50,3),rep(15,3),rep(10,3)),2),
                ...
                lambda = rep(c(rep(450e-4,3),rep(550e-5,3),rep(170e-4,3),rep(130e-4,3)),2),
...
example_index <- which(scenarios$n1 == 50)
...
save(small_scenarios,file=vfile('~/adaperm_simresults/simulations_newrules'))
