...
run_scenario <- function(scenario){
    ...
    nE <- combination_power_rule_w_ts(x1,y1,pp=delta2res(delta=delta0,sigma0,T),lambda=lambda,maxN=6*length(x1),propn=propn)
...
load('~/srv-home/adaperm_simresults/small_simulations_newrules_node2_160929.Rd')
load('~/srv-home/adaperm_simresults/medium_simulations_newrules_node2_160929.Rd')
load('~/srv-home/adaperm_simresults/large_simulations_newrules_node6_160929.Rd')
...
colnames(sims)[14:ncol(sims)] <- c('CT:T','CT:W','CER:T','CER:W','CER$^r$:W')#,'CER$^r$:W$_\\textrm{mid-p}$')#,'CER:Tu','CER:Wu')
