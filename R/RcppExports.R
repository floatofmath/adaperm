...
all_combinations_cpp <- function(n, k) {
    .Call('adaperm_all_combinations_cpp', PACKAGE = 'adaperm', n, k)
}

all_reassignments_cpp <- function(n, k) {
    .Call('adaperm_all_reassignments_cpp', PACKAGE = 'adaperm', n, k)
}
