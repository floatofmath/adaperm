...
##'  @param alpha0 Early rejection boundary for group sequential trial
...
##'
##' @details Group sequentialism assumes that the trial does not stop at the first stage - otherwise second stage data would not be available. 
